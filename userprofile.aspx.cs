    ...
    public partial class userprofile : System.Web.UI.Page
    {
        ...
        void UpdateUserPersonalDetails()
        {
            ...
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("update member_master_tbl set full_name=@full_name, dob=@dob, mobile_no=@mobile_no, email=@email, state=@state, city=@city, postal_code=@postal_code, full_address=@full_address, password=@password, account_status=@account_status WHERE user_id='" + Session["username"].ToString().Trim() + "'", con);
